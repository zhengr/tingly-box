...
// assembled Anthropic beta response. The first mutation supported here is block
...
func MutateAnthropicV1BetaResponse(resp *anthropic.BetaMessage, evaluation Evaluation) (bool, string) {
